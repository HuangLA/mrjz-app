...
The Island theme uses the published [`animal-island-ui`](https://github.com/guokaigdg/animal-island-ui) React Button and Footer components, Nunito / Noto Sans SC fonts, sea footer, and selected item illustrations under the project's [CC BY-NC 4.0 license](https://github.com/guokaigdg/animal-island-ui/blob/main/LICENSE). MRJZ is a non-commercial community project. The reused illustrations are resized, cropped, and placed in new page layouts; the upstream demo site is not copied into this repository. Large Chinese headings use [ZCOOL KuaiLe via Fontsource](https://fontsource.org/fonts/zcool-kuaile) under the SIL Open Font License 1.1.
